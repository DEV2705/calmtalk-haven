...
function Sheet({ open, onOpenChange, children, ...props }) {
  return (
    <div className={cn("sheet", open ? "open" : "closed")} {...props}>
      {children}
    </div>
  );
}

function SheetContent({ className, side, ...props }) {
  return <div className={cn("sheet-content", side, className)} {...props} />;
}
...
function TooltipTrigger({ asChild, children }) {
  ...
  return <Comp className="tooltip-trigger">{children}</Comp>;
}

function TooltipContent({ className, ...props }) {
  return <div className={cn("tooltip-content", className)} {...props} />;
}
